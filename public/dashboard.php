...
$nameQuery = $pdo->prepare("SELECT display_name FROM users WHERE id = ? LIMIT 1");
$nameQuery->execute([$_SESSION["user_id"]]);
$displayName = trim((string) $nameQuery->fetchColumn());
$greetingName = $displayName !== "" ? $displayName : $username;
?>
...
<body data-theme="<?= htmlspecialchars($theme) ?>">
    <main class="container">
        ...
        <h1>Welcome back, <?= htmlspecialchars($greetingName) ?>.</h1>
